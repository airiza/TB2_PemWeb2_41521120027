                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Data Rak</h6>
                        </div>
                        <div class="card-body">
                            <form action="<?php echo $action ?>" method="POST">
                                <input name="id_rak" type="hidden" class="form-control" id="inputEmail4" value="<?php echo $dataRak->id_rak ?>">

                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                    <label for="inputEmail4">Nama Rak</label>
                                    <input name="nama_rak" type="text" class="form-control" id="inputEmail4" value="<?php echo $dataRak->nama_rak ?>" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                    <label for="inputPassword4">Lokasi Rak</label>
                                    <input name="lokasi_rak" type="text" class="form-control" id="inputPassword4" value="<?php echo $dataRak->lokasi_rak ?>" required>
                                    </div>
                                </div>
