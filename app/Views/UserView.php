                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php foreach($data as $index => $value) { ?>
                                            <tr>
                                                ...
                                                <?php if (session()->dataUser->jabatan_petugas == 'Admin') { ?>
                                                    <td align="center">
														<a href="<?php echo base_url().'/User/Detail/'.$value->id_petugas ?>" title='Detail'><i class="fas fa-search"></i></a>
                                                        <a href="<?php echo base_url().'/User/EditUser/'.$value->id_petugas ?>" title='Edit'><i class="fas fa-edit"></i></a>
                                                        <a href="<?php echo base_url().'/User/HapusUser/'.$value->id_petugas ?>" title='Hapus'><i class="fas fa-trash"></i></a>
                                                    </td>
                                                <?php } ?>
                                            </tr>
                                        <?php } ?>
							...
							<a class="btn btn-primary" href="<?php echo base_url('User/generatePDF/') ?>">
								Download PDF
							</a>
							<a class="btn btn-success" href="<?php echo base_url('User/generateExcel/') ?>">
								Download Excel
							</a>
                        </div>
                    </div>
