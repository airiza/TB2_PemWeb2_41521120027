								...
								<div class="form-row">
									<div class="form-group col-md-4 ">
										...
										<div class="text-center">
										  <img src="<?php echo base_url() ?>/template/img/undraw_profile.svg" class="card-img-top rounded img-circle" style="width: 80%;">
										</div>
										<div class="card-body">
											<h5 class="card-title"><?php echo $dataUser->nama_petugas .'(<i>'.$dataUser->jabatan_petugas.'</i>)'; ?></h5>
											<p class="card-text"><?php echo $dataUser->nim_petugas; ?></p>
										  </div>
										</div>	
									</div>
									<div class="form-group col-md-8">
										<div class="form-row">
											<div class="form-group col-md-6">
												...
												value="<?php echo $dataUser->nama_petugas; ?>" disabled>
											</div>
											<div class="form-group col-md-6">
												<label for="inputEmail4">NIM</label>
												<input name="nim_petugas" type="text" class="form-control" id="nim_petugas" 
												value="<?php echo $dataUser->nim_petugas; ?>" disabled>
											</div>
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												...
												<input name="username_petugas" type="text" class="form-control" id="username_petugas" 
												value="<?php echo $dataUser->username_petugas; ?>" disabled>
											</div>
											<div class="form-group col-md-6">
												<label for="inputPassword4">Jabatan</label>
												<select id="jabatan_petugas" class="form-control" name="jabatan_petugas" disabled>
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												...
												<input name="alamat_petugas" type="text" class="form-control" id="alamat_petugas" 
												value="<?php echo $dataUser->alamat_petugas; ?>" disabled>
											</div>
											<div class="form-group col-md-6">
												<label for="inputPassword4">Nomor Telp</label>
												<input name="no_telp_petugas" type="text" class="form-control" id="no_telp_petugas"
												value="<?php echo $dataUser->no_telp_petugas; ?>" disabled>
											</div>
										</div>
									</div>
								</div>
